...
public class ExpensesActivity extends AppCompatActivity {
    ...
    AdminActivityExpensesBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = AdminActivityExpensesBinding.inflate(getLayoutInflater());
    ...
    public void fetchExpenses() {
        ...
        webServices.getExpenses(request, new WebServices.onGetExpenses() {
            ...
            public void getExpenses(List<ModelExpenses.Expenses> expenseList) {
                binding.rvExpenses.setLayoutManager(new LinearLayoutManager(ExpensesActivity.this));
                binding.rvExpenses.setAdapter(new AdapterExpenses(ExpensesActivity.this, expenseList));
            }
        });
    }
